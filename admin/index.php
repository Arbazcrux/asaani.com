...
if(isset($_GET['view'])){
	echo "<h1 style='text-align: center;' class='alert alert-info'>Users</h1>";
...
$sel_users="select * from login order by 1 DESC LIMIT 0,10";
...
if(isset($_GET['del'])){
		...
		$delete_user = "delete from login where user_id='$del_id'";
...
if(isset($_GET['edit'])){
	$edit_id= $_GET['edit'];
	$get_user="select*from login where user_id='$edit_id'";
...
if(isset($_POST['update'])){
	...
	$update_users="update login set username='$regname',email='$regemail',password='$regpass' where user_id='$update_id'
	";
...
if(isset($_POST['update'])){
	...
	$update_users="update login set user_name='$regname',user_email='$regemail',user_num='$regpass',category='$ergcat',adress='$regadd' where user_id='$update_id'
	";
	$run_update=mysqli_query($con,$update_users);
	if($run_update){
		echo"<script>alert('A user has been update')</script>";
...
if(isset($_POST['update'])){
	...
	$update_users="update login set user_name='$regname',user_email='$regemail',subject='$ergcat',message='$regadd' where user_id='$update_id'
	";
	$run_update=mysqli_query($con,$update_users);
	if($run_update){
		echo"<script>alert('A user has been update')</script>";
